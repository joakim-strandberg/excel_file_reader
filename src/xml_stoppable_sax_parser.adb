...
package body XML_Stoppable_SAX_Parser is
      ...
      then
         ...
         if CP = Character'Pos ('>') then
               ...
               case State_Id is
                  ...
                  when Found_Less_Sign =>
                     if CP = Character'Pos ('!') then
                        ...
                        if (not Shall_Continue) or Call_Result.Has_Failed then
                           exit;
                        end if;
                  ...
                  when Expecting_G_Sign_Or_Attributes_And_Found_Slash =>
                     if CP = Character'Pos ('>') then
                        ...
                        This.Text ("", Shall_Continue, Call_Result);
            ...
            if
              ...
              State_Id /= Expecting_Only_Trailing_Spaces and then
              Shall_Continue
            then
         ...
         when XML_S_VERSION_E_Q_1_P_0_Q_S_ENC_E_Q_UTF_D_8_Q_QM =>
            if CP = Character'Pos (' ') then
               ...
               if P <= Contents'Last then
                  ...
                  This.Analyze_XML (P, Contents, Shall_Continue, Call_Result);
               else
